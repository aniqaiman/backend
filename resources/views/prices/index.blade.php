                        ...
                        <table class="table" id="dashboard-table" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ number_format($product["difference"]->seller_price_a, 2, '.', '') }}%</td>
                                    <td class="text-center">{{ number_format($product["difference"]->buyer_price_a, 2, '.', '') }}%</td>
                                    <td class="text-center">{{ number_format($product["difference"]->seller_price_b, 2, '.', '') }}%</td>
                                    <td class="text-center">{{ number_format($product["difference"]->buyer_price_b, 2, '.', '') }}%</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
