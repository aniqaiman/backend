                  ...
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        RM {{ number_format($product->priceLatest()["buyer_price_b"], 2) }} @break @case("C") RM {{ number_format($product->priceLatest()["buyer_price_b"],
                        2) }} @break @endswitch
                      </td>
                      <td>
                        ...
                        2) }} @break @case("C") RM {{ number_format($product->pivot->quantity * $product->priceLatest()["buyer_price_b"],
                        2) }} @break @endswitch
                      </td>
                    </tr>
                    @endforeach
