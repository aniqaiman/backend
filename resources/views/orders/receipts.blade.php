                  ...
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        RM {{ number_format($product->priceLatest()->price_b, 2) }} @break @case("B") RM {{ number_format($product->priceLatest()->price_c,
                        2) }} @break @endswitch
                      </td>
                      <td>
                        ...
                        2) }} @break @case("B") RM {{ number_format($product->pivot->quantity * $product->priceLatest()->price_c,
                        2) }} @break @endswitch
                      </td>
                    </tr>
                    @endforeach
