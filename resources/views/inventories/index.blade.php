                ...
                <tr>
                  ...
                  <td>
                    <div class="input-group">
                      <input type="number" id="wastage_{{ $inventory->product->id}}" class="wastage form-control" value="{{ $inventory->wastage }}"
                  ...
                  <td>
                    <div class="input-group">
                      <input type="number" class="demand form-control" value=" value=" {{ $inventory->promotion }} style="min-width:
                      70px;" />
                      <div class="input-group-addon">kg</div>
                    </div>
                  </td>
